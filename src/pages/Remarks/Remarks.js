      ...
      <div className={Styles.JobDetalTop}>
        ...
        <div className={Styles.ControlMain}>
          {originalApiCommentDetails.length ? (
            ...
            <>{isLoading ? <CircleLoading /> : <div className={Styles.NoData}>No Comments.</div>}</>
          )}
          {/* add comment section */}
            ...
            <Form>
              <div className={Styles.BottomChatFixed}>
                ...
                <div className={Styles.Chatsend}>
                  ...
                  <button type="submit" disabled={isLoading} className={isLoading ? `${Styles.my_button_loading}` : null}>
