...
export const UserProfile = Yup.object({
  ...
  contact: Yup.number("Phone number is use only number").min(100000000, "Phone number must be 10 characters!").max(9999999999, "Invalid Phone number").required("This field is required"),
